  ...
  for (int i = 0; i < a; i++){
    for (int j = 0; j < b; j++){
     ...
     // ymm10 = _mm256_setzero_ps();  ymm11 = _mm256_setzero_ps();
      ...
      ymm0 = _mm256_mul_ps(ymm12, ymm13);
      ymm1 = _mm256_mul_ps(ymm12, ymm14);

      ymm12 = _mm256_loadu_ps(src_ptr + line_len);
      ymm12 = _mm256_permutevar8x32_ps(ymm12, ymm15); //00112233
      ymm2 = _mm256_mul_ps(ymm12, ymm13);
      ymm3 = _mm256_mul_ps(ymm12, ymm14);
 
      ymm12 = _mm256_loadu_ps(src_ptr + 2 * line_len);
      ymm12 = _mm256_permutevar8x32_ps(ymm12, ymm15); //00112233
      ymm4 = _mm256_mul_ps(ymm12, ymm13);
      ymm5 = _mm256_mul_ps(ymm12, ymm14);



      ymm12 = _mm256_loadu_ps(src_ptr + 4);
      ymm12 = _mm256_permutevar8x32_ps(ymm12, ymm15); //00112233
      ymm6 = _mm256_mul_ps(ymm12, ymm13);
      ymm7 = _mm256_mul_ps(ymm12, ymm14);

      ymm12 = _mm256_loadu_ps(src_ptr + line_len + 4);
      ymm12 = _mm256_permutevar8x32_ps(ymm12, ymm15); //00112233
      ymm8 = _mm256_mul_ps(ymm12, ymm13);
      ymm9 = _mm256_mul_ps(ymm12, ymm14);

      ymm12 = _mm256_loadu_ps(src_ptr + 2 * line_len + 4);
      ymm12 = _mm256_permutevar8x32_ps(ymm12, ymm15); //00112233
      ymm10 = _mm256_mul_ps(ymm12, ymm13);
      ymm11 = _mm256_mul_ps(ymm12, ymm14);
